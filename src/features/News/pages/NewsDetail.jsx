  ...
  return (
    <div>
      ...
      <div className="flex mt-[100px] max-w-[1200px] mx-auto">
        ...
        <div
          className={
            "mt-[300px] w-[25%] bg-white z-50 p-2 h-[fit-content] fixed right-0 top-0 mr-4 border-[1px] border-gray-300 overflow-auto transition-all duration-300 " +
            (scroll ? "!mt-[62px]" : "")
          }
        >
          <h1 className="font-bold bg-red-700 text-white py-1 px-2">
            {t("news.other")}
          </h1>
          {!loading
            ? otherNews
                ...
                .map((news) => (
                  <Link
                    to={`/news/${news.slug}`}
                    className="flex mb-4 border-b-[1px] p-1"
                  >
                    ...
                    <p className="flex-1 text-xs font-medium line-clamp-2">
                      {news.title}
                    </p>
                  </Link>
                ))

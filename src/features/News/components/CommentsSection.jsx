...
const CommentsSection = ({ news, newsComments, onNewComment }) => {
  ...
  return (
    <div className="w-3/4">
      <h1 className="my-6 font-bold text-2xl">{t("news.comment")}</h1>
      <div className="p-4 flex flex-col border-[1px] border-gray-400 rounded-lg">
        ...
        {loading && (
          <div className="mx-auto">
            <Spinner borderColor="border-red-700" />
          </div>
        )}
        ...
        {currentUser ? (
          <div>
            ...
            <form onSubmit={handlePostComment}>
              <div className="flex">
                ...
                <textarea
                  className="w-full p-2 text-sm border-[1px] border-gray-400"
                  rows="5"
                  ref={commentRef}
                  type="text"
                  required
              ...
              <button
                className="block ml-auto mt-4 text-white text-sm bg-red-700 font-semibold p-2"
                type="submit"
              >
                Bình luận
              </button>
          ...
          <p className="text-center font-semibold bg-red-700 py-2 text-white">

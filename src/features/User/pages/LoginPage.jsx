...
const LoginPage = () => {
  ...
  return (
    ...
    >
      <Link
        to="/"
        className="logo text-center block py-4 text-4xl border-b-[1px]"
      >
      ...
      <div className="bg-gray-100 h-full p-4">
        <div className="max-w-max bg-white mx-auto p-6 pt-0 min-w-[400px]">
          <div className="w-full flex justify-between">
            <button
              className={
                "w-[48%] text-xs py-4 border-b-2 border-gray-400 mb-2 " +
                (toggleActive === 1 ? "!border-black" : "")
              }
